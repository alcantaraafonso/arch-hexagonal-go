...
import (
	...
	application "github.com/alcantaraafonso/go-hexagonal/application"
...
func (m *MockProductServiceInterface) Create(product application.Product) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
